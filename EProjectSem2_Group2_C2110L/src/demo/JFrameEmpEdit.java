...
public class JFrameEmpEdit extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JFrameEmpEdit frame = new JFrameEmpEdit();
	...
	public JFrameEmpEdit(Map<String, Object> data) {
		this();
		this.data = data;
		initJFrame();
	}
	...
	private void initJFrame() {
		...
		jdateChooser.setDate(employee.getCreated());
		jcheckboxAdmin.setSelected(employee.isIs_admin());
	}
