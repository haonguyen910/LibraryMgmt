...
public class JPanelAuthorEdit extends JPanel {
...
//	Global Variable
	 ...
	 * Create the panel.
	 */
	public JPanelAuthorEdit(JPanel JpanelRight) {
		...
		add(panel_1_1);
		panel_1_1.setLayout(new FlowLayout(FlowLayout.LEFT, 20, 10));
	 ...
	 */
	public JPanelAuthorEdit(JPanel JpanelRight, Map<String, Object> data) {
		this(JpanelRight);
		this.data = data;
		initJFrame();
	}
...
//	Functions
	private void initJFrame() {
		...
		jtextFieldId.setText(String.valueOf(author.getId()));
